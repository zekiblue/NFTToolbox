...
export default {
  ...
  computed: {
    ...
    // },
    itemId: function () {
      return this.info.contract_address + ':' + this.info.token_id
    },
    name: function () {
    ...
    contractAddress: function () {
      return this.info.contract_address.toLowerCase()
    },
    token_id: function () {
    ...
    image_url: function () {      
      if (this.info.metadata && this.info.metadata.opensea_cached_image) {
        return this.fixImageURL(this.info.metadata.opensea_cached_image)
      }
      else if (this.info.metadata && this.info.metadata.image) {
        return this.fixImageURL(this.info.metadata.image)
      }
      else if (this.info.cached_file_url) {
        return this.fixImageURL(this.info.cached_file_url)
      }
      else if (this.info.file_url) {
        return this.fixImageURL(this.info.file_url)
      }      
      else {
        return null
      }
    ...
    token_url: function () {
      if (this.info.metadata && this.info.metadata.external_link) {
        return this.info.metadata.external_link
      }
      else if (this.info.external_link) {
    ...
    opensea_url: function () {
      ...
      return openseaRootURL + this.info.contract_address + '/' + this.info.token_id + '?ref=' + openseaRef
